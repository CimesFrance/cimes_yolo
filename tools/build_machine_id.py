...
def build() -> None:
    ...
    cmd = [
        ...
        "--name", "machine_id",                   # Nom du fichier de sortie
        ...
        "--paths", os.path.join(src_dir, "license"),
    ...
    icon_path = os.path.join(project_root, "modules", "app_change_corr_params", "assets", "icons", "cimes-logo.ico")
    if os.path.exists(icon_path):
        ...
        print(f"[AVERTISSEMENT] Icône introuvable à {icon_path} — compilation sans icône.")
