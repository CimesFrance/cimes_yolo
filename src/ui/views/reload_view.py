...
class ReloadView(ImageAnalyzer, CsvManager):
    ...
    def _setup_sidebar(self):
        ...
        tk.Label(
            content,
            text="Analyse d'image :",
            bg=COLOR_CARD_BG,
            font=("Segoe UI", 10, "bold"),
        ).pack(anchor="w", pady=(0, 5))
        ttk.Button(
            content,
            text="Parcourir image",
    ...
    def _setup_csv_section(self, parent):
        ...
        tk.Label(
            parent,
            text="Courbes de tamisage CSV :",
            bg=COLOR_CARD_BG,
            font=("Segoe UI", 10, "bold"),
        ).pack(anchor="w", pady=(0, 5))
        ttk.Button(
            parent,
            text=" Charger courbe CSV",
        ...
        csv_canvas = tk.Canvas(
            csv_list_frame, bg=COLOR_CARD_BG, highlightthickness=0, height=150
        )
        scrollbar = ttk.Scrollbar(
            csv_list_frame, orient="vertical", command=csv_canvas.yview
        )
    ...
    def _setup_results_area(self):
        ...
        self.segmented_image_container = tk.Frame(
            self.segmented_image_tab, bg=COLOR_CARD_BG
        )
